...
import { JobCategory, JobCategoryId } from '@/types/job';
import { EquipmentSlotType, EquipmentSlot, EquipmentItem, JobEquipment, hasItem, hasOptions } from '@/types/equipment';
