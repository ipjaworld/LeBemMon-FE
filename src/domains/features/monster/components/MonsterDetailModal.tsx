...
import { Region } from '@/domains/entities/location/types/region';
import { GameMap } from '@/domains/entities/location/types/map';
...
import mapData from '@/domains/entities/location/data/map_data.json';
import monsterItemRelations from '@/domains/features/monster/data/monster_item_relations.json';
