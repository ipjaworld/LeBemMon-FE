import type { JobCategoryId } from '@/domains/entities/job/types/job';
import type { EquipmentSlotType, EquipmentItem } from '@/domains/features/equipment/types/equipment';
