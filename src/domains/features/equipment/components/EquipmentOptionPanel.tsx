...
import { EquipmentSlotType, EquipmentItem, EquipmentOptions } from '@/domains/features/equipment/types/equipment';
import { Item } from '@/domains/entities/item/types/item';
import { JobCategoryId } from '@/domains/entities/job/types/job';
import itemData from '@/domains/entities/item/data/item_data.json';
import ItemComboBox from '@/domains/entities/item/ItemComboBox';
