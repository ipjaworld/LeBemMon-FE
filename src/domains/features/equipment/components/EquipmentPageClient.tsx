...
import EquipmentWindow from '@/domains/features/equipment/components/EquipmentWindow';
import EquipmentOptionPanel from '@/domains/features/equipment/components/EquipmentOptionPanel';
import CharacterStatWindow from '@/domains/features/equipment/components/CharacterStatWindow';
import PresetSaveModal from '@/domains/features/equipment/components/PresetSaveModal';
import { EquipmentSlotType, EquipmentItem } from '@/domains/features/equipment/types/equipment';
import { Item } from '@/domains/entities/item/types/item';
import { JobCategoryId, JobCategory } from '@/domains/entities/job/types/job';
import type { CharacterSnapshot, EquipmentPreset } from '@/domains/features/equipment/types/preset';
import { getPresets, savePreset, loadPreset, deletePreset } from '@/domains/features/equipment/presetStorage';
import jobData from '@/domains/entities/job/data/job_data.json';
import itemData from '@/domains/entities/item/data/item_data.json';
